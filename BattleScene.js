    ...
    var BattleScene = (function() 
    {
        ...
        function BattleScene(props) 
        {
            ...
            } else
            {
                ...
                // {
                //     Bjh.SoundAdapter.PlayMusic("battle2", 1);
                // } else  //普通副本.
                else
                {
        ...
        p._RebuildUI = function()
        {
            ...
            // if (!window.isBTversion && this.battleType == Bjh.BattleType.Dungeon)
            // {
            //     var btn_fast_y = 115;
        ...
        p.startVideo = function()
        {
            ...
            //     if(timeBol)
            //     {
            //         Bjh.UIUtils.prompt("录屏失败：录屏时长低于 3 秒");
            //     }
            //     else
            //     {
...
// console.log(">>释放前:" + num_before);
            ...
            // if (!Bjh.Porting.effConfig.keepBattleRes)
            // {
            //     _loader.DeepClearResDir(Bjh.Porting.resPath + "/Hero/");                
            //     _loader.DeepClearResDir(Bjh.Porting.resPath + "/Monster/");
            //     _loader.DeepClearResDir(Bjh.Porting.resPath + "/Battle/Effect/");
            // }
            // _loader.DeepClearResDir(Bjh.Porting.resPath + "/Battle/Treasure.zip");
